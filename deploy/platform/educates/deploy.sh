...
loadWorkshop() {
    ...
    for i in {1..2} # TODO - make this configurable based pon the files in the directory
    do
        export LAB_NUM="`printf "%02d\n" $i`"
        export IMAGE_TAG="latest"
        envsubst < ${DIR}/../../../workshop-resources/workshop-deploy-${LAB_NUM}.yaml | kubectl apply -f -
    done
    envsubst < ${DIR}/../../../workshop-resources/workshop-deploy.yaml | kubectl apply -f -
